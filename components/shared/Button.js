...
export default function Button({ text, onPress, primary = true, style = {}, textStyle = {}, viewStyle = {} }) {
   return (
      ...
      >
         <View style={[styles.view, primary ? styles.viewPrimary : styles.viewNoPrimary, viewStyle]}>
            <Text
               style={[
                  typefaces.pm,
...
const styles = {
   ...
   view: tailwind('flex flex-row justify-center border rounded-md items-center w-full py-2'),
