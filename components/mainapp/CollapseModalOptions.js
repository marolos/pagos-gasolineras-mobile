...
import { logos, getLogoByPath } from '../../utils/mocks';
      ...
      <View style={tailwind('w-full h-64 bg-white rounded-t-lg')}>
        <View style={tailwind('p-6')}>
          <View style={tailwind('flex flex-row items-center')}>
            <Image source={getLogoByPath(company.company.company_logo_path)} style={{ width: 50, height: 50 }} />
            <Text style={[tailwind('mt-2 ml-2 text-lg'), typefaces.psb]}>{company.company.business_name}</Text>
          </View>
